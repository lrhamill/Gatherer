...
public var consentDocument: ORKConsentDocument {
    ...
    var consentSections: [ORKConsentSection] = consentSectionTypes.map { contentSectionType in
        ...
        case .Withdrawing:
            ...
            consentSection.content = "I understand that participation in this study is entirely voluntary and that I can withdraw from the study at any time without giving a reason. I understand that I can contact the research team from the app, or directly via this email address: HamillLR@cardiff.ac.uk"
